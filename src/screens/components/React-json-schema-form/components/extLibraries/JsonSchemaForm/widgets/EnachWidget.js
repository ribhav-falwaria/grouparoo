...
const createSubscription = async (
  ...
  crashlytics().log(
    ErrorUtil.createLog(
      "createSubscription method starts here ",
      { formName, planId, applicationId, primaryPhone, expiresOn, appUrl },
      "createSubscription()",
      "EnachWidget.js"
    )
  );
...
const EnachWidget = (props) => {
  crashlytics().log(
    ErrorUtil.createLog(
      "EnachWidget method starts here ",
      { props },
      "EnachWidget()",
      "EnachWidget.js"
    )
  ...
  const eMandateHandler = () => {
    crashlytics().log(
      ErrorUtil.createLog(
        "eMandateHandler method starts here ",
        undefined,
        "eMandateHandler()",
        "EnachWidget.js"
      )
