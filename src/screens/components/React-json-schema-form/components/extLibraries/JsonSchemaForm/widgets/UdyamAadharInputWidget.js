...
const validateUdyam = async (dispatch, udyam) => {
  crashlytics().log(
    ErrorUtil.createLog(
      "validateUdyam method starts here ",
      { dispatch, udyam },
      "validateUdyam()",
      "UdyamAadharInputWidgetPasswordWidget.js"
    )
  );
...
const stripPrefix = (udyamPrefix, value) => {
  crashlytics().log(
    ErrorUtil.createLog(
      "stripPrefix method starts here ",
      { udyamPrefix, value },
      "stripPrefix()",
      "UdyamAadharInputWidgetPasswordWidget.js"
    )
...
const UdyamAadharInputWidget = ({
  ...
  crashlytics().log(
    ErrorUtil.createLog(
      "UdyamAadharInputWidget method starts here ",
      {
        id,
        readonly,
        disabled,
